...
export default function LightPage() {
    return (
      <div className="min-h-screen justify-items-center bg-white text-black rounded-lg px-6 py-8 ring ring-gray-900/5">
      <h1 className="text-4xl">LIGHT MODE SAMPLE</h1>
      <Image
      ...
      />
      <p className="bg-blue-100 px-5 py-2 m-3 rounded-lg text-center border-3 border-indigo-600">
        上の画像は imageタグを使っています。
        </p>

      <h1 className="bg-slate-200 rounded-lg text-[32px] p-3">
        HTMLのサンプル h1 タグです
      </h1>
      <p>これはサンプルの p タグです</p>
