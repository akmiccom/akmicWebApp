...
export default function About() {
    return (
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-blue-600 mb-4">About akmic</h1>
            ...
            <div className="mx-auto flex max-w-sm items-center gap-x-4 rounded-xl bg-white p-6 shadow-lg outline outline-black/5 dark:bg-slate-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
                <Image className="size-12 shrink-0" src="/globe.svg" alt="ChitChat Logo" width={50} height={50} />
                <div className="text-xl font-medium text-black dark:text-white">ChitChat</div>
                <p className="text-gray-500 dark:text-gray-400">You have a new message!</p>
            </div>

            <div className="flex flex-col gap-2 p-8 sm:flex-row sm:items-center sm:gap-6 sm:py-4 ...">
                <Image className="mx-auto block h-24 rounded-full sm:mx-0 sm:shrink-0" src="/images/ana_tokuten_01_1920_1080.webp" alt=""  width={192} height={108}/>
